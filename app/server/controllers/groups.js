...
exports.createGroup = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerCreateGroup";
...
exports.getGroups= function(req, res) {
	// Technical title : 
	var tachnical_title = "groupsControllerGetGroups";

	// Check if user have permission
	Utils.isAuthorized(req, req.body.group_id, tachnical_title).then(function(isAuthorized) {
		if(isAuthorized) {
			// Get list of groups
			Group.find().populate('created_by').exec(function(err, groups) {
				// Check err
				if(err) 
					return Utils.sendError(res, err);
				// Send groups
				res.json({login: req.login, message: Utils.Constants._MSG_OK_, details: groups, code: Utils.Constants._CODE_OK_});
			});
		} else {
			Utils.sendUnauthorized(req, res);
			return;
...
exports.getGroup = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerGetGroup";
	...
	Utils.isAuthorized(req, req.body.group_id, tachnical_title).then(function(isAuthorized) {
		...
		if(isAuthorized) {
			...
			if(req.query.full == Utils.Constants._TRUE_) {
				...
				// Get group by Id
				Group.findById(req.params.group_id).populate('created_by').exec(function(err, group){
					if(err)
						// Send error
						return Utils.sendError(res, err);
					if(group != null) 
...
exports.findGroup = function(req, res) {
	// Technical title : 
	var tachnical_title = "groupsControllerFindGroup";
	...
	Utils.isAuthorized(req, tachnical_title).then(function(isAuthorized) {
		...
		if(isAuthorized) {
			...
			Group.find({$or :[
						...
						}).populate('created_by').exec(function(err, groups) {
				if (err)
					return Utils.sendError(res, err);
...
// Find user role
exports.findUserRole = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerFindUserRole";
...
exports.updateGroup = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerUpdateGroup";
						...
						Promise.any([newRolePromise]).then(function(result) {
							...
							if(null != req.body.users_role && req.body.users_role.length > 0) {
								...
								req.body.users_role.map(
										function(userRole) { 
											if(null != userRole.user && null != userRole.role) {
												if(userRole.user instanceof Object && userRole.role instanceof Object) {
													group.users_role.push(new Object(
														{'user': userRole.user._id, 'role': userRole.role._id}));
												} else if(userRole.role != "" && userRole.user != "") {
													group.users_role.push(new Object(
...
exports.deleteGroup = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerDeleteGroup";
...
exports.userRole = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerUserRole";
...
exports.removeUser = function(req, res) {
	...
	// Technical title : 
	var tachnical_title = "groupsControllerRemoveUser";
				...
				if(err)
					...
					User.findById(req.body.user_id, function(err, user) {
			            ...
			            if(user != null) {
							...
							var listRoles = [];
							group.users_role.map(function(ur) {
								if(ur.user != req.body.user_id) listRoles.push(ur);
							})
		            		group.users_role = listRoles;
...
exports.addBoardInstance = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerAddBoardInstance";
...
exports.boardInstanceDetails = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerBoardInstanceDetails";
...
exports.removeBoardInstance = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerRemoveBoardInstance";
...
// Add user in board instance
exports.addUserToBoardInstance = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerAddUserToBoardInstance";
...
exports.removeUserFromBoardInstance = function(req, res) {

	// Technical title : 
	var tachnical_title = "groupsControllerRemoveUserFromBoardInstance";
